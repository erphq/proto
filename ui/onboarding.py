...
class OnboardingFlow:
    ...
    def show_welcome(self):
        ...
        subtitle = Text(
            "Let's get you set up with your ClickHouse AI Agent",
    ...
    def setup_openrouter(self) -> Dict[str, Any]:
        ...
        info_panel = Panel(
            Text.assemble(
                ...
                "\n\n",
                (
                    "OpenRouter gives you access to multiple AI models including:",
                    "bright_white",
                ),
                "\n",
        ...
        return {
            ...
            "openrouter_provider_only": (
                "openai" if model_choice in ["1", "2"] else "anthropic"
            ),
    ...
    def setup_local(self) -> Dict[str, Any]:
        ...
        info_panel = Panel(
            Text.assemble(
                ...
                "\n\n",
                (
                    "Your ClickHouse AI Agent will be automatically downloaded and started.",
                    "bright_white",
                ),
                "\n",
    ...
    def setup_lmstudio(self) -> Dict[str, Any]:
        ...
        info_panel = Panel(
            Text.assemble(
                ...
                "\n",
                ("• Download from: ", "bright_white"),
                ("https://lmstudio.ai", "bright_blue underline"),
                "\n",
        ...
        return {"provider": "lmstudio", "lmstudio_base_url": base_url}
    ...
    def setup_clickhouse(self) -> Dict[str, Any]:
        ...
        if connection_type == "local":
            ...
            port = int(
                Prompt.ask("[bold bright_cyan]Port[/bold bright_cyan]", default="8123")
            )
            username = Prompt.ask(
                "[bold bright_cyan]Username[/bold bright_cyan]", default="default"
            )
            password = Prompt.ask(
                "[bold bright_cyan]Password[/bold bright_cyan]", password=True
            )
            database = Prompt.ask(
                "[bold bright_cyan]Database[/bold bright_cyan]", default="default"
            )
...
def needs_onboarding() -> bool:
    ...
    active_config_file = (
        ...
        else legacy_config_file if legacy_config_file.exists() else None
    )
    if active_config_file and active_config_file.exists():
        try:
            with open(active_config_file, "r") as f:
                ...
                )  # Also check if provider is explicitly set to local
